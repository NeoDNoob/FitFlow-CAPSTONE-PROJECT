...
public class OwnerPOSOffline extends JFrame implements Runnable {
...
private String userType;
   ...
   public OwnerPOSOffline(int selectedIndex, final String username, final String userType, final int loggedInUserId) {
      ...
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(OwnerPOSOffline.class.getResource("/Resources/FitFlowIconPngResized.png")));
      ...
      this.POSInvTabbedPane.addChangeListener(new ChangeListener() {
		...
		public void stateChanged(ChangeEvent e) {
            ...
            if (selectedIndex == 1) {
               OwnerPOSOffline.this.clearPosProductFields();
               OwnerPOSOffline.this.checkOverstock();
               OwnerPOSOffline.this.loadTableData();
               OwnerPOSOffline.this.populateInboundTable();
            } else if (selectedIndex == 2) {
               OwnerPOSOffline.this.populateInboundTable();
               OwnerPOSOffline.this.clearInvProductFields();
      ...
      new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/POSicon.png"));
      ...
      this.POSInvTabbedPane.addTab("Point of Sale", new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/POS.png")), pos, "Point of Sale");
      ...
      this.posBarcodeField.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
    	        if (e.getKeyCode() == 10) {
    	            String barcode = OwnerPOSOffline.this.posBarcodeField.getText();
    	            ...
    	            try (Connection con = ConnectionProvider.getCon();
    	                ...
    	                try (ResultSet rs = pstmt.executeQuery()) {
    	                    if (rs.next()) {
    	                        OwnerPOSOffline.this.posProductNameField.setText(rs.getString("product_name"));
    	                        OwnerPOSOffline.this.posPriceField.setText(rs.getString("retail_price"));
    	                        OwnerPOSOffline.this.posQtyField.setText("1");
    	                    } else {
    	                        JOptionPane.showMessageDialog((Component) null, "Barcode not found.");
    	                        OwnerPOSOffline.this.posBarcodeField.setText("");
    	                    }
    	                }
      ...
      posMinusButt.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            int currentQty = Integer.parseInt(OwnerPOSOffline.this.posQtyField.getText());
            if (currentQty > 0) {
               --currentQty;
               OwnerPOSOffline.this.posQtyField.setText(String.valueOf(currentQty));
               if (currentQty == 0) {
      ...
      posMinusButt.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/minus.png")));
      ...
      posAddButt.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/addition.png")));
      ...
      toCartField.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/add-to-cart.png")));
      ...
      POSLabel.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/payment-terminal(1).png")));
      ...
      posDeleteButton.addMouseListener(new MouseAdapter() {
         @Override
		public void mouseClicked(MouseEvent e) {
            OwnerPOSOffline.this.cartTableModel.removeRow(OwnerPOSOffline.this.cartTable.getSelectedRow());
            int sum = 0;

            for(int i = 0; i < OwnerPOSOffline.this.cartTable.getRowCount(); ++i) {
               sum += Integer.parseInt(OwnerPOSOffline.this.cartTable.getValueAt(i, 4).toString());
            }

            OwnerPOSOffline.this.posSTField.setText(Integer.toString(sum));
         }
      });
      posDeleteButton.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/trash.png")));
      ...
      posFInalize.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            int pay = Integer.parseInt(OwnerPOSOffline.this.posPayField.getText());
            int subtotal = Integer.parseInt(OwnerPOSOffline.this.posSTField.getText());
            int balance = pay - subtotal;
            OwnerPOSOffline.this.posChangeField.setText(String.valueOf(balance));
            OwnerPOSOffline.this.sales(username);
            OwnerPOSOffline.this.salesModel.fireTableStructureChanged();
            OwnerPOSOffline.this.tableModel.fireTableStructureChanged();
         }
      });
      posFInalize.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/bill.png")));
      ...
      this.POSInvTabbedPane.addTab("Inventory", new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/list.png")), inventory, (String)null);
      inventory.setLayout((LayoutManager)null);
      JLabel inventoryLabel = new JLabel("Inventory");
      inventoryLabel.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/shipping.png")));
      ...
      invAddProd.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
        	 AddProductOwnerOffline add = new AddProductOwnerOffline(OwnerPOSOffline.this);
            add.setVisible(true);
         }
      });
      invAddProd.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/add-small.png")));
      ...
      this.invTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
		...
		public void valueChanged(ListSelectionEvent e) {
            if (!e.getValueIsAdjusting()) {
               int selectedRow = OwnerPOSOffline.this.invTable.getSelectedRow();
               if (selectedRow != -1) {
                  OwnerPOSOffline.this.invBarcodeField.setText((String)OwnerPOSOffline.this.invTable.getValueAt(selectedRow, 1));
                  OwnerPOSOffline.this.invProductNameField.setText((String)OwnerPOSOffline.this.invTable.getValueAt(selectedRow, 2));
                  OwnerPOSOffline.this.invQtyField.setText(String.valueOf(OwnerPOSOffline.this.invTable.getValueAt(selectedRow, 3)));
                  OwnerPOSOffline.this.invCpField.setText(String.valueOf(OwnerPOSOffline.this.invTable.getValueAt(selectedRow, 4)));
                  OwnerPOSOffline.this.invRpField.setText(String.valueOf(OwnerPOSOffline.this.invTable.getValueAt(selectedRow, 5)));
               }
            }
      ...
      invUpdateProduct.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            int selectedRow = OwnerPOSOffline.this.inboundTable.getSelectedRow();
            if (selectedRow == -1) {
               JOptionPane.showMessageDialog(OwnerPOSOffline.this, "Please select a row to update.");
            } else {
               String productId = OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 0).toString();
               String eta = OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 6).toString();
               String status = OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 7).toString();
               InboundUpdateOwnerOffline updateInboundFrame = new InboundUpdateOwnerOffline(productId, eta, status, OwnerPOSOffline.this);
               updateInboundFrame.setVisible(true);
            }
         }
      });
      invUpdateProduct.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/edit.png")));
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        if (confirm != null && !confirm.isEmpty()) {
    	            if (confirm.equals("Confirm")) {
    	                int selectedRow = OwnerPOSOffline.this.invTable.getSelectedRow();
    	                if (selectedRow != -1) {
    	                    int id = (Integer) OwnerPOSOffline.this.invTable.getValueAt(selectedRow, 0);
    	                    String barcode = (String) OwnerPOSOffline.this.invTable.getValueAt(selectedRow, 1);
    	                    ...
    	                    try (Connection con = ConnectionProvider.getCon();
    	                        ...
    	                        if (rowsAffected > 0) {
    	                            DefaultTableModel cartTableModel = (DefaultTableModel) OwnerPOSOffline.this.invTable.getModel();
      ...
      invDeleteProduct.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/trash.png")));
      ...
      delivered.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        if (selectedRow == -1) {
    	            ...
    	            try (Connection con = ConnectionProvider.getCon()) {
    	                if (con != null) {
    	                    String productName = (String) OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 1);
    	                    String barcode = (String) OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 2);
    	                    int quantity = Integer.parseInt(OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 3).toString());
    	                    double costPrice = Double.parseDouble(OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 4).toString());
    	                    double retailPrice = Double.parseDouble(OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 5).toString());
    	                    Date etaDate = (Date) OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 6);
    	                    @SuppressWarnings("unused")
							String status = (String) OwnerPOSOffline.this.inboundTable.getValueAt(selectedRow, 7);
    	                    Date today = new Date();
    	                    ...
    	                    ((DefaultTableModel) OwnerPOSOffline.this.inboundTable.getModel()).removeRow(selectedRow);
    	                    OwnerPOSOffline.this.loadTableData();
    	                }
      ...
      delivered.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/changes.png")));
      ...
      this.POSInvTabbedPane.addTab("History", new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/file.png")), this.history, (String)null);
      this.history.setLayout((LayoutManager)null);
      JLabel lblHistory = new JLabel("History");
      lblHistory.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/filegold.png")));
      ...
      dateSortYears.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if (!selectedYear.equals("Select Year")) {
               OwnerPOSOffline.this.populateYearlySales(selectedYear);
            }
      ...
      dateSortMonths.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if (!selectedMonth.equals("Select Month") && !selectedYear.equals("Select Year")) {
               ...
               OwnerPOSOffline.this.populateMonthlySales(monthNumber, selectedYear);
            }
	...
	final JComboBox<String> dateSort1 = new JComboBox(sortingOptionsDate);
		...
		public void actionPerformed(ActionEvent e) {
            ...
            case 80981793:
               if (selectedOption.equals("Today")) {
                  dateSortMonths.setVisible(false);
                  dateSortYears.setVisible(false);
                  OwnerPOSOffline.this.populateDailySales();
                  return;
               }
               break;
            case 1384532022:
               if (selectedOption.equals("This Week")) {
                  dateSortMonths.setVisible(false);
                  dateSortYears.setVisible(false);
                  OwnerPOSOffline.this.populateWeeklySales();
                  return;
               }
            }
      ...
      sortComboBox.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            OwnerPOSOffline.this.sortByColumn = selectedOption.equals("Total Sales") ? "total_sales_amount" : "s.date";
            ...
            OwnerPOSOffline.this.populateSalesHistory(OwnerPOSOffline.this.salesModel, OwnerPOSOffline.this.sortByColumn);
            OwnerPOSOffline.this.salesModel.fireTableStructureChanged();
         }
      });
      JButton viewDetailsButton = new JButton("View Details");
      viewDetailsButton.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/search-file.png")));
      ...
      viewDetailsButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if (selectedRow != -1) {
               ...
               OwnerPOSOffline.this.showOrderDetails(salesId);
            } else {
      ...
      this.POSInvTabbedPane.addTab("Sales Report", new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/sales.png")), report, (String)null);
      report.setLayout((LayoutManager)null);
      JLabel lblSalesReport = new JLabel("Sales Report");
      lblSalesReport.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/sales-gold.png")));
      ...
      exportButton.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/pdf-file.png")));
      ...
      exportButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            OwnerPOSOffline.this.exportToPDF();
         }
      });
      ...
      toggleSalesSummary.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOSOffline.this.contentPanel.getLayout();
            cl.show(OwnerPOSOffline.this.contentPanel, "Sales Summary");
         }
      });
      toggleSalesOverTimeChart.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOSOffline.this.contentPanel.getLayout();
            cl.show(OwnerPOSOffline.this.contentPanel, "Sales Over Time Chart");
         }
      });
      toggleProductSales.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOSOffline.this.contentPanel.getLayout();
            cl.show(OwnerPOSOffline.this.contentPanel, "Product Sales");
         }
      });
      toggleProfitMargins.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOSOffline.this.contentPanel.getLayout();
            cl.show(OwnerPOSOffline.this.contentPanel, "Profit Margins");
         }
      });
      tglbtnOverallGym.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOSOffline.this.contentPanel.getLayout();
            cl.show(OwnerPOSOffline.this.contentPanel, "Payments and Sales Summary");
         }
      });
      ...
      toGMButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            OwnerPOSOffline.this.setVisible(false);
         }
      });
      toGMButton.setBackground(new Color(224, 177, 25));
      toGMButton.setIcon(new ImageIcon(OwnerPOSOffline.class.getResource("/Resources/weight.png")));
