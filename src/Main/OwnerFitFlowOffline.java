...
public class OwnerFitFlowOffline extends JFrame {
...
public OwnerFitFlowOffline(int selectedIndex, final String username, final String userType, final int loggedInUserId) {
    	                ...
    	                try (PreparedStatement ps = connection.prepareStatement(query)) {
    	                    ...
    	                    if (rowsUpdated > 0) {
    	                        if (choice == 0) {
    	                            ...
    	                            new LoginForm();
    	                            OwnerFitFlowOffline.this.dispose();
    	                        }
    	                    } else {
      ...
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(OwnerFitFlowOffline.class.getResource("/Resources/FitFlowIconPngResized.png")));
      ...
      this.tabbedPane.addChangeListener(new ChangeListener() {
		...
		public void stateChanged(ChangeEvent e) {
            ...
            if (selectedIndex == 1) {
               OwnerFitFlowOffline.this.updateTableData();
               OwnerFitFlowOffline.this.model.fireTableStructureChanged();
               OwnerFitFlowOffline.this.checkForUnpaidTrainees();
            } else if (selectedIndex == 2) {
               OwnerFitFlowOffline.this.updateActiveMembersLabel();
            } else if (selectedIndex == 3) {
               OwnerFitFlowOffline.this.setDateLabel();
            } else if (selectedIndex == 4) {
               OwnerFitFlowOffline.this.loadDataTable();
            }
      ...
      this.tabbedPane.addTab("Home ", new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/home-icon-silhouette.png")), homePanel, "Home");
      ...
      this.tabbedPane.addTab("Trainee List ", new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/group.png")), this.traineePanel, (String)null);
      JLabel traineeLabel = new JLabel("Trainee List");
      traineeLabel.setForeground(new Color(255, 215, 0));
      traineeLabel.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/users.png")));
      ...
      this.tabbedPane.addTab("Manage Trainee ", new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/user-avatar.png")), this.editTraineePanel, (String)null);
      ...
      lblEditTrainee.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/pencil.png")));
      ...
      mtSearchButton.addActionListener(new ActionListener() {
    	    ...
    	    public void actionPerformed(ActionEvent e) {
    	        ...
    	        String id = OwnerFitFlowOffline.this.mtSearchField.getText().trim();
    	        ...
    	        try (Connection con = ConnectionProvider.getCon();
    	            ...
    	            try (ResultSet rst = ps.executeQuery()) {
    	                ...
    	                while (rst.next()) {
    	                    checkID = true;
    	                    OwnerFitFlowOffline.this.mtNameField.setText(rst.getString("name"));
    	                    OwnerFitFlowOffline.this.mtAgeField.setText(rst.getString("age"));
    	                    OwnerFitFlowOffline.this.mtSexField.setText(rst.getString("sex"));
    	                    OwnerFitFlowOffline.this.mtSexField.setEditable(false);
    	                    OwnerFitFlowOffline.this.mtMnField.setText(rst.getString("mobile_number"));
    	                    OwnerFitFlowOffline.this.mtEmailField.setText(rst.getString("email"));
      ...
      mtSearchButton.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/magnifying-glass.png")));
      ...
      mtUpdateButton.addActionListener(new ActionListener() {
    	    ...
    	    public void actionPerformed(ActionEvent e) {
    	        ...
    	        String id = OwnerFitFlowOffline.this.mtSearchField.getText().trim();
    	        String name = OwnerFitFlowOffline.this.mtNameField.getText().trim();
    	        String age = OwnerFitFlowOffline.this.mtAgeField.getText().trim();
    	        String mobileNumber = OwnerFitFlowOffline.this.mtMnField.getText().trim();
    	        String email = OwnerFitFlowOffline.this.mtEmailField.getText().trim();
    	        ...
    	        try (Connection con = ConnectionProvider.getCon();
    	            ...
    	            if (rowsUpdated > 0) {
    	                ...
    	                OwnerFitFlowOffline.this.mtSearchField.setText("");
    	                OwnerFitFlowOffline.this.mtSearchField.setEditable(true);
    	                OwnerFitFlowOffline.this.mtNameField.setText("");
    	                OwnerFitFlowOffline.this.mtAgeField.setText("");
    	                OwnerFitFlowOffline.this.mtSexField.setText("");
    	                OwnerFitFlowOffline.this.mtEmailField.setText("");
    	                OwnerFitFlowOffline.this.mtMnField.setText("");
      ...
      mtUpdateButton.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/changes.png")));
      ...
      mtDeleteButton.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/trash.png")));
      ...
      mtResetButton.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/undo.png")));
      ...
      this.tabbedPane.addTab("Trainee Payment ", new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/wallet-filled-money-tool.png")), membershipPaymentPanel, "Trainee Payment");
      ...
      lblPayment.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/wallet.png")));
      ...
      tpSaveButton.addActionListener(new ActionListener() {
    	    @Override
    	    public void actionPerformed(ActionEvent e) {
    	        String memberName = OwnerFitFlowOffline.this.tpNameField.getText();
    	        String paymentTime = (String) tpPaymentTimeField.getSelectedItem();

    	        if (OwnerFitFlowOffline.this.isPaymentAllowed(memberName, paymentTime)) {
    	            String date = OwnerFitFlowOffline.this.tpDateLabel.getText();
    	            String amount = OwnerFitFlowOffline.this.tpPaymentField.getText();
    	            ...
    	            try (Connection con = ConnectionProvider.getCon();
    	                ...
    	                OwnerFitFlowOffline.this.tableDetails();
    	            ...
    	            if (result == 0) {
    	                OwnerFitFlowOffline.this.printReceipt(receipt.toString());
    	            }

    	            // Clear input fields
    	            OwnerFitFlowOffline.this.tpNameField.setText("");
    	            OwnerFitFlowOffline.this.tpPaymentField.setText("");
    	            OwnerFitFlowOffline.this.tpEmailField.setText("");
    	            OwnerFitFlowOffline.this.tpMnField.setText("");
    	            tpPaymentTimeField.setSelectedItem("Please Select");
    	        }
    	    }
    	});

      tpSaveButton.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/diskette.png")));
      ...
      tpSearchButton.addActionListener(new ActionListener() {
    	    ...
    	    public void actionPerformed(ActionEvent e) {
    	        OwnerFitFlowOffline.this.setDateLabel();
    	        String id = OwnerFitFlowOffline.this.tpSearchField.getText();
    	        String date = OwnerFitFlowOffline.this.tpDateLabel.getText();
    	        ...
    	        try (Connection con = ConnectionProvider.getCon()) {
    	            ...
    	            try (PreparedStatement pst = con.prepareStatement(memberQuery)) {
    	                ...
    	                try (ResultSet rst = pst.executeQuery()) {
    	                    if (rst.next()) {
    	                        checkID = true;
    	                        OwnerFitFlowOffline.this.tpEmailField.setText(rst.getString("email"));
    	                        OwnerFitFlowOffline.this.tpNameField.setText(rst.getString("name"));
    	                        OwnerFitFlowOffline.this.tpMnField.setText(rst.getString("mobile_number"));
      ...
      tpSearchButton.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/magnifying-glass.png")));
      ...
      tpResetButton1.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            OwnerFitFlowOffline.this.tpSearchField.setText("");
            OwnerFitFlowOffline.this.tpNameField.setText("");
            OwnerFitFlowOffline.this.tpMnField.setText("");
            OwnerFitFlowOffline.this.tpEmailField.setText("");
            OwnerFitFlowOffline.this.tpPaymentField.setText("");
      ...
      tpResetButton1.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/undo.png")));
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        if (confirm != null && !confirm.isEmpty()) {
    	            if (confirm.equals("Confirm")) {
    	                int selectedRow = OwnerFitFlowOffline.this.tpTable.getSelectedRow();
    	                if (selectedRow != -1) {
    	                    ...
    	                    if (confirmation == JOptionPane.YES_OPTION) {
    	                        String date = (String) OwnerFitFlowOffline.this.tpTable.getValueAt(selectedRow, 1);
    	                        String name = (String) OwnerFitFlowOffline.this.tpTable.getValueAt(selectedRow, 0);
    	                        ...
    	                        try (Connection con1 = ConnectionProvider.getCon();
    	                            ...
    	                            if (rowsDeleted > 0) {
    	                                DefaultTableModel dtm = (DefaultTableModel) OwnerFitFlowOffline.this.tpTable.getModel();
      ...
      tpDeleteButton.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/trash.png")));
      ...
      this.tpDateSorter.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            String selectedOption = (String)OwnerFitFlowOffline.this.tpDateSorter.getSelectedItem();
            switch(selectedOption.hashCode()) {
            case -1650694486:
               if (selectedOption.equals("Yearly")) {
                  OwnerFitFlowOffline.this.tpMonthSorter.setVisible(false);
                  OwnerFitFlowOffline.this.tpYearSorter.setVisible(true);
                  OwnerFitFlowOffline.this.showYearlyPayments();
               }
               break;
            case -1393678355:
               if (selectedOption.equals("Monthly")) {
                  OwnerFitFlowOffline.this.tpMonthSorter.setVisible(true);
                  OwnerFitFlowOffline.this.tpYearSorter.setVisible(true);
                  OwnerFitFlowOffline.this.showMonthlyPayments();
               }
               break;
            case 65921:
               if (selectedOption.equals("All")) {
                  OwnerFitFlowOffline.this.tableDetails();
                  OwnerFitFlowOffline.this.tpMonthSorter.setVisible(false);
                  OwnerFitFlowOffline.this.tpYearSorter.setVisible(false);
               }
               break;
            case 80981793:
               if (selectedOption.equals("Today")) {
                  OwnerFitFlowOffline.this.showTodayPayments();
                  OwnerFitFlowOffline.this.tpMonthSorter.setVisible(false);
                  OwnerFitFlowOffline.this.tpYearSorter.setVisible(false);
               }
               break;
            case 1384532022:
               if (selectedOption.equals("This Week")) {
                  OwnerFitFlowOffline.this.showThisWeekPayments();
                  OwnerFitFlowOffline.this.tpMonthSorter.setVisible(false);
                  OwnerFitFlowOffline.this.tpYearSorter.setVisible(false);
               }
            }
      ...
      this.tabbedPane.addTab("Gym Reports", new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/sales.png")), this.gymReports, (String)null);
      ...
      this.yearComboBox.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            OwnerFitFlowOffline.this.updateMembershipChart();
         }
      });
      this.membershipButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            OwnerFitFlowOffline.this.cardLayout.show(OwnerFitFlowOffline.this.cardPanel, "Membership");
            OwnerFitFlowOffline.this.updateMembershipChart();
            yearLabel.setVisible(true);
            OwnerFitFlowOffline.this.yearComboBox.setVisible(true);
         }
      });
      this.paymentTypeButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            OwnerFitFlowOffline.this.cardLayout.show(OwnerFitFlowOffline.this.cardPanel, "PaymentType");
            OwnerFitFlowOffline.this.updatePaymentTypeChart();
         }
      });
      this.ageDistributionButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            OwnerFitFlowOffline.this.cardLayout.show(OwnerFitFlowOffline.this.cardPanel, "AgeDistribution");
            OwnerFitFlowOffline.this.updateAgeDistributionChart();
         }
      });
      this.addressDistributionButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            OwnerFitFlowOffline.this.cardLayout.show(OwnerFitFlowOffline.this.cardPanel, "AddressDistribution");
            OwnerFitFlowOffline.this.updateAddressDistributionChart();
         }
      });
      this.genderDistributionButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            OwnerFitFlowOffline.this.cardLayout.show(OwnerFitFlowOffline.this.cardPanel, "GenderDistribution");
            OwnerFitFlowOffline.this.updateGenderDistributionChart();
         }
      });
      ...
      toPOSButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            OwnerFitFlowOffline.this.setVisible(false);
         }
      });
      toPOSButton.setBackground(new Color(224, 177, 25));
      toPOSButton.setIcon(new ImageIcon(OwnerFitFlowOffline.class.getResource("/Resources/POS.png")));
   ...
   public void showMonthlyPayments() {
	    this.tpMonthSorter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
	            DefaultTableModel dtm = (DefaultTableModel) OwnerFitFlowOffline.this.tpTable.getModel();
	            dtm.setRowCount(0);
	            int monthIndex = OwnerFitFlowOffline.this.tpMonthSorter.getSelectedIndex() + 1;
	            String selectedYear = (String) OwnerFitFlowOffline.this.tpYearSorter.getSelectedItem();
