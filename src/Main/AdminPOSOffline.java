...
public class AdminPOSOffline extends JFrame implements Runnable {
...
private String userType;
   ...
   public AdminPOSOffline(int selectedIndex, final String username, final String userType, final int loggedInUserId) {
      ...
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(AdminPOSOffline.class.getResource("/Resources/FitFlowIconPngResized.png")));
      ...
      this.POSInvTabbedPane.addChangeListener(new ChangeListener() {
		...
		public void stateChanged(ChangeEvent e) {
            ...
            if (selectedIndex == 1) {
               AdminPOSOffline.this.clearPosProductFields();
               AdminPOSOffline.this.checkOverstock();
               AdminPOSOffline.this.loadTableData();
               AdminPOSOffline.this.populateInboundTable();
            } else if (selectedIndex == 2) {
               AdminPOSOffline.this.populateInboundTable();
               AdminPOSOffline.this.clearInvProductFields();
      ...
      new ImageIcon(AdminPOSOffline.class.getResource("/Resources/POSicon.png"));
      ...
      this.POSInvTabbedPane.addTab("Point of Sale", new ImageIcon(AdminPOSOffline.class.getResource("/Resources/POS.png")), pos, "Point of Sale");
      ...
      this.posBarcodeField.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
    	        if (e.getKeyCode() == 10) {
    	            String barcode = AdminPOSOffline.this.posBarcodeField.getText();
    	            ...
    	            try (Connection con = ConnectionProviderOFFLINE.getCon();
    	                ...
    	                try (ResultSet rs = pstmt.executeQuery()) {
    	                    if (rs.next()) {
    	                        AdminPOSOffline.this.posProductNameField.setText(rs.getString("product_name"));
    	                        AdminPOSOffline.this.posPriceField.setText(rs.getString("retail_price"));
    	                        AdminPOSOffline.this.posQtyField.setText("1");
    	                    } else {
    	                        JOptionPane.showMessageDialog((Component) null, "Barcode not found.");
    	                        AdminPOSOffline.this.posBarcodeField.setText("");
    	                    }
    	                }
      ...
      posMinusButt.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            int currentQty = Integer.parseInt(AdminPOSOffline.this.posQtyField.getText());
            if (currentQty > 0) {
               --currentQty;
               AdminPOSOffline.this.posQtyField.setText(String.valueOf(currentQty));
               if (currentQty == 0) {
      ...
      posMinusButt.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/minus.png")));
      ...
      posAddButt.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/addition.png")));
      ...
      toCartField.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/add-to-cart.png")));
      ...
      //POSLabel.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/payment-terminal (1).png")));
      ...
      posDeleteButton.addMouseListener(new MouseAdapter() {
         @Override
		public void mouseClicked(MouseEvent e) {
            AdminPOSOffline.this.cartTableModel.removeRow(AdminPOSOffline.this.cartTable.getSelectedRow());
            int sum = 0;

            for(int i = 0; i < AdminPOSOffline.this.cartTable.getRowCount(); ++i) {
               sum += Integer.parseInt(AdminPOSOffline.this.cartTable.getValueAt(i, 4).toString());
            }

            AdminPOSOffline.this.posSTField.setText(Integer.toString(sum));
         }
      });
      ...
      posFInalize.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            int pay = Integer.parseInt(AdminPOSOffline.this.posPayField.getText());
            int subtotal = Integer.parseInt(AdminPOSOffline.this.posSTField.getText());
            int balance = pay - subtotal;
            AdminPOSOffline.this.posChangeField.setText(String.valueOf(balance));
            AdminPOSOffline.this.sales(username);
            AdminPOSOffline.this.salesModel.fireTableStructureChanged();
            AdminPOSOffline.this.tableModel.fireTableStructureChanged();
         }
      });
      ...
      this.POSInvTabbedPane.addTab("Inventory", new ImageIcon(AdminPOSOffline.class.getResource("/Resources/list.png")), inventory, (String)null);
      inventory.setLayout((LayoutManager)null);
      JLabel inventoryLabel = new JLabel("Inventory");
      inventoryLabel.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/shipping.png")));
      ...
      invAddProd.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AddProductOffline add = new AddProductOffline(AdminPOSOffline.this);
            add.setVisible(true);
         }
      });
      invAddProd.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/add-small.png")));
      ...
      this.invTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
		...
		public void valueChanged(ListSelectionEvent e) {
            if (!e.getValueIsAdjusting()) {
               int selectedRow = AdminPOSOffline.this.invTable.getSelectedRow();
               if (selectedRow != -1) {
                  AdminPOSOffline.this.invBarcodeField.setText((String)AdminPOSOffline.this.invTable.getValueAt(selectedRow, 1));
                  AdminPOSOffline.this.invProductNameField.setText((String)AdminPOSOffline.this.invTable.getValueAt(selectedRow, 2));
                  AdminPOSOffline.this.invQtyField.setText(String.valueOf(AdminPOSOffline.this.invTable.getValueAt(selectedRow, 3)));
                  AdminPOSOffline.this.invCpField.setText(String.valueOf(AdminPOSOffline.this.invTable.getValueAt(selectedRow, 4)));
                  AdminPOSOffline.this.invRpField.setText(String.valueOf(AdminPOSOffline.this.invTable.getValueAt(selectedRow, 5)));
               }
            }
      ...
      invUpdateProduct.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            int selectedRow = AdminPOSOffline.this.inboundTable.getSelectedRow();
            if (selectedRow == -1) {
               JOptionPane.showMessageDialog(AdminPOSOffline.this, "Please select a row to update.");
            } else {
               String productId = AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 0).toString();
               String eta = AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 6).toString();
               String status = AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 7).toString();
               InboundUpdateOffline updateInboundFrame = new InboundUpdateOffline(productId, eta, status, AdminPOSOffline.this);
               updateInboundFrame.setVisible(true);
            }
         }
      });
      invUpdateProduct.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/edit.png")));
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        if (confirm != null && !confirm.isEmpty()) {
    	            if (confirm.equals("Confirm")) {
    	                int selectedRow = AdminPOSOffline.this.invTable.getSelectedRow();
    	                if (selectedRow != -1) {
    	                    int id = (Integer) AdminPOSOffline.this.invTable.getValueAt(selectedRow, 0);
    	                    String barcode = (String) AdminPOSOffline.this.invTable.getValueAt(selectedRow, 1);
    	                    ...
    	                    try (Connection con = ConnectionProviderOFFLINE.getCon();
    	                        ...
    	                        if (rowsAffected > 0) {
    	                            DefaultTableModel cartTableModel = (DefaultTableModel) AdminPOSOffline.this.invTable.getModel();
      ...
      invDeleteProduct.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/trash.png")));
      ...
      delivered.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        if (selectedRow == -1) {
    	            ...
    	            try (Connection con = ConnectionProviderOFFLINE.getCon()) {
    	                if (con != null) {
    	                    String productName = (String) AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 1);
    	                    String barcode = (String) AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 2);
    	                    int quantity = Integer.parseInt(AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 3).toString());
    	                    double costPrice = Double.parseDouble(AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 4).toString());
    	                    double retailPrice = Double.parseDouble(AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 5).toString());
    	                    Date etaDate = (Date) AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 6);
    	                    @SuppressWarnings("unused")
							String status = (String) AdminPOSOffline.this.inboundTable.getValueAt(selectedRow, 7);
    	                    Date today = new Date();
    	                    ...
    	                    ((DefaultTableModel) AdminPOSOffline.this.inboundTable.getModel()).removeRow(selectedRow);
    	                    AdminPOSOffline.this.loadTableData();
    	                }
      ...
      delivered.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/changes.png")));
      ...
      this.POSInvTabbedPane.addTab("History", new ImageIcon(AdminPOSOffline.class.getResource("/Resources/file.png")), this.history, (String)null);
      this.history.setLayout((LayoutManager)null);
      JLabel lblHistory = new JLabel("History");
      lblHistory.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/filegold.png")));
      ...
      dateSortYears.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if (!selectedYear.equals("Select Year")) {
               AdminPOSOffline.this.populateYearlySales(selectedYear);
            }
      ...
      dateSortMonths.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if (!selectedMonth.equals("Select Month") && !selectedYear.equals("Select Year")) {
               ...
               AdminPOSOffline.this.populateMonthlySales(monthNumber, selectedYear);
            }
	...
	final JComboBox<String> dateSort1 = new JComboBox(sortingOptionsDate);
		...
		public void actionPerformed(ActionEvent e) {
            ...
            case 80981793:
               if (selectedOption.equals("Today")) {
                  dateSortMonths.setVisible(false);
                  dateSortYears.setVisible(false);
                  AdminPOSOffline.this.populateDailySales();
                  return;
               }
               break;
            case 1384532022:
               if (selectedOption.equals("This Week")) {
                  dateSortMonths.setVisible(false);
                  dateSortYears.setVisible(false);
                  AdminPOSOffline.this.populateWeeklySales();
                  return;
               }
            }
      ...
      sortComboBox.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            AdminPOSOffline.this.sortByColumn = selectedOption.equals("Total Sales") ? "total_sales_amount" : "s.date";
            ...
            AdminPOSOffline.this.populateSalesHistory(AdminPOSOffline.this.salesModel, AdminPOSOffline.this.sortByColumn);
            AdminPOSOffline.this.salesModel.fireTableStructureChanged();
         }
      });
      JButton viewDetailsButton = new JButton("View Details");
      viewDetailsButton.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/search-file.png")));
      ...
      viewDetailsButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if (selectedRow != -1) {
               ...
               AdminPOSOffline.this.showOrderDetails(salesId);
            } else {
      ...
      this.POSInvTabbedPane.addTab("Sales Report", new ImageIcon(AdminPOSOffline.class.getResource("/Resources/sales.png")), report, (String)null);
      report.setLayout((LayoutManager)null);
      JLabel lblSalesReport = new JLabel("Sales Report");
      lblSalesReport.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/sales-gold.png")));
      ...
      exportButton.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/pdf-file.png")));
      ...
      exportButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminPOSOffline.this.exportToPDF();
         }
      });
      ...
      toggleSalesSummary.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)AdminPOSOffline.this.contentPanel.getLayout();
            cl.show(AdminPOSOffline.this.contentPanel, "Sales Summary");
         }
      });
      toggleSalesOverTimeChart.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)AdminPOSOffline.this.contentPanel.getLayout();
            cl.show(AdminPOSOffline.this.contentPanel, "Sales Over Time Chart");
         }
      });
      toggleProductSales.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)AdminPOSOffline.this.contentPanel.getLayout();
            cl.show(AdminPOSOffline.this.contentPanel, "Product Sales");
         }
      });
      toggleProfitMargins.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)AdminPOSOffline.this.contentPanel.getLayout();
            cl.show(AdminPOSOffline.this.contentPanel, "Profit Margins");
         }
      });
      tglbtnOverallGym.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)AdminPOSOffline.this.contentPanel.getLayout();
            cl.show(AdminPOSOffline.this.contentPanel, "Payments and Sales Summary");
         }
      });
      ...
      toGMButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            (new AdminFitFlowOffline(0, username, userType, loggedInUserId)).setVisible(true);
            AdminPOSOffline.this.setVisible(false);
         }
      });
      toGMButton.setBackground(new Color(224, 177, 25));
      toGMButton.setIcon(new ImageIcon(AdminPOSOffline.class.getResource("/Resources/weight.png")));
      ...
      this.getContentPane().add(userLabel, BorderLayout.NORTH);
...
private List<BufferedImage> fetchChartImages() {
   ...
   private void loadTableData() {
      ...
      label164: {
         try {
            var21 = true;
            con = ConnectionProviderOFFLINE.getCon();
   ...
   private void populateDailySales() {
	    ...
	    try (Connection conn = ConnectionProviderOFFLINE.getCon();
