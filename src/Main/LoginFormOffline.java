/* Decompiler 234ms, total 907ms, lines 357 */
package Main;
...
public class LoginFormOffline extends JFrame {
   LoginFormOffline() {
      ...
      this.setTitle("FitFlow Offline - Login");
      this.setSize(1000, 650);
      this.setResizable(false);
      this.setLocationRelativeTo((Component)null);
      this.getContentPane().setBackground(new Color(255, 223, 88));
      this.setBackground(new Color(255, 223, 88));
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(LoginFormOffline.class.getResource("/Resources/FitFlowIconPngResized.png")));
      this.getContentPane().setLayout((LayoutManager)null);
      JLabel loginImage = new JLabel();
      loginImage.setBounds(317, 5, 350, 600);
      loginImage.setIcon(new ImageIcon(LoginFormOffline.class.getResource("/Resources/idolsImage.png")));
      this.getContentPane().add(loginImage);
      JLabel loginText = new JLabel("LOGIN TO FITFLOW");
      loginText.setBackground(new Color(0, 0, 0));
      ...
      forgotPass.setIcon(new ImageIcon(LoginFormOffline.class.getResource("/Resources/forgot-password.png")));
      ...
      offlineMode.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            int conf = JOptionPane.showConfirmDialog((Component)null, "Are you sure you want to switch to Online mode?", "Confirmation", 0);
            if (conf == 0) {
               new LoginForm();
               LoginFormOffline.this.dispose();
            }
      ...
      offlineMode.setIcon(new ImageIcon(LoginFormOffline.class.getResource("/Resources/wifi-signal.png")));
      ...
      JLabel offLabel = new JLabel("Online Mode");
      ...
      feedbackButton.setBounds(909, 559, 65, 41);
      feedbackButton.setIcon(new ImageIcon(LoginFormOffline.class.getResource("/Resources/feedbackblack.png")));
    	            ...
    	            try (ResultSet rs = ps.executeQuery()) {
    	                if (rs.next()) {
    	                    ...
    	                    if ("Owner".equals(userType)) {
    	                        new OwnerFitFlowOffline(selectedIndex, loggedInUsername, userType, loggedInUserId).setVisible(true);
    	                    } else if ("Staff".equals(userType)) {
    	                        new StaffFitFlowOffline(selectedIndex, loggedInUsername, userType, loggedInUserId).setVisible(true);
    	                    } else {
    	                        new AdminFitFlowOffline(selectedIndex, loggedInUsername, userType, loggedInUserId).setVisible(true);
    	                    }
