...
public class InboundUpdateOffline extends JFrame {
   private JComboBox<String> DStatusBox;
   private JDateChooser dateChooser;
   private String productId;
   private AdminPOSOffline parentFrame;

   @SuppressWarnings({ "unchecked", "rawtypes" })
public InboundUpdateOffline(String productId, String eta, String status, AdminPOSOffline parentFrame) {
      ...
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(InboundUpdateOffline.class.getResource("/resources/Black_and_Brown_Vintage_Fitness_Center_Logo_-removebg-preview.png")));
      ...
      updateInbound.setIcon(new ImageIcon(InboundUpdateOffline.class.getResource("/resources/edit.png")));
