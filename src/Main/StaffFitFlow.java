...
public class StaffFitFlow extends JFrame {
...
public StaffFitFlow(int selectedIndex, final String username, final String userType, final int loggedInUserId) {
      ...
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(StaffFitFlow.class.getResource("/Resources/FitFlowIconPngResized.png")));
      ...
      this.tabbedPane.addChangeListener(new ChangeListener() {
		...
		public void stateChanged(ChangeEvent e) {
            ...
            if (selectedIndex == 1) {
               StaffFitFlow.this.updateTableData();
               StaffFitFlow.this.model.fireTableStructureChanged();
               StaffFitFlow.this.checkForUnpaidTrainees();
               StaffFitFlow.this.updateActiveMembersLabel();
            } else if (selectedIndex == 2) {
               StaffFitFlow.this.updateActiveMembersLabel();
            } else if (selectedIndex == 3) {
               StaffFitFlow.this.setDateLabel();
            }
      ...
      this.tabbedPane.addTab("Home ", new ImageIcon(StaffFitFlow.class.getResource("/Resources/home-icon-silhouette.png")), homePanel, "Home");
      ...
      this.tabbedPane.addTab("Trainee List ", new ImageIcon(StaffFitFlow.class.getResource("/Resources/group.png")), this.traineePanel, (String)null);
      JLabel traineeLabel = new JLabel("Trainee List");
      traineeLabel.setForeground(new Color(255, 215, 0));
      traineeLabel.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/users.png")));
      ...
      this.tabbedPane.addTab("Manage Trainee ", new ImageIcon(StaffFitFlow.class.getResource("/Resources/user-avatar.png")), this.editTraineePanel, (String)null);
      ...
      lblEditTrainee.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/pencil.png")));
      ...
      mtSearchButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        String id = StaffFitFlow.this.mtSearchField.getText();

    	        try (Connection con = ConnectionProvider.getCon()) {  // Using try-with-Resources to handle connection
    	            Statement st = con.createStatement();
    	            ResultSet rst = st.executeQuery("SELECT * FROM member WHERE id = '" + id + "'");

    	            while (rst.next()) {
    	                checkID = true;
    	                StaffFitFlow.this.mtNameField.setText(rst.getString(3));
    	                StaffFitFlow.this.mtAgeField.setText(rst.getString(4));
    	                StaffFitFlow.this.mtSexField.setText(rst.getString(5));
    	                StaffFitFlow.this.mtSexField.setEditable(false);  // Ensures this field is non-editable
    	                StaffFitFlow.this.mtMnField.setText(rst.getString(7));
    	                StaffFitFlow.this.mtEmailField.setText(rst.getString(2));
      ...
      mtSearchButton.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/magnifying-glass.png")));
      ...
      mtUpdateButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            String id = StaffFitFlow.this.mtSearchField.getText();
            String name = StaffFitFlow.this.mtNameField.getText();
            String age = StaffFitFlow.this.mtAgeField.getText();
            String mobilenumber = StaffFitFlow.this.mtMnField.getText();
            String email = StaffFitFlow.this.mtEmailField.getText();
            ...
            try {
               ...
               StaffFitFlow.this.mtSearchField.setText("");
               StaffFitFlow.this.mtSearchField.setEditable(true);
               StaffFitFlow.this.mtNameField.setText("");
               StaffFitFlow.this.mtAgeField.setText("");
               StaffFitFlow.this.mtSexField.setText("");
               StaffFitFlow.this.mtEmailField.setText("");
               StaffFitFlow.this.mtMnField.setText("");
               StaffFitFlow.this.mtEmailField.setText("");
      ...
      mtUpdateButton.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/changes.png")));
      ...
      mtDeleteButton.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/trash.png")));
      ...
      mtResetButton.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/magnifying-glass.png")));
      ...
      this.tabbedPane.addTab("Trainee Payment ", new ImageIcon(StaffFitFlow.class.getResource("/Resources/wallet-filled-money-tool.png")), membershipPaymentPanel, "Trainee Payment");
      ...
      lblPayment.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/wallet.png")));
      ...
      tpSaveButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            String memberName = StaffFitFlow.this.tpNameField.getText();
            String paymentTime = (String)tpPaymentTimeField.getSelectedItem();
            if (StaffFitFlow.this.isPaymentAllowed(memberName, paymentTime)) {
               String date = StaffFitFlow.this.tpDateLabel.getText();
               StaffFitFlow.this.amount = StaffFitFlow.this.tpPaymentField.getText();
               ...
               try {
                  ...
                  ps.setString(3, StaffFitFlow.this.amount);
               ...
               receipt.append("    Amount to Pay: ₱").append(StaffFitFlow.this.amount).append("\n");
               ...
               StaffFitFlow.this.tpNameField.setText("");
               StaffFitFlow.this.tpPaymentField.setText("");
               StaffFitFlow.this.tpEmailField.setText("");
               StaffFitFlow.this.tpMnField.setText("");
               ...
               if (result == 0) {
                  StaffFitFlow.this.printReceipt(receipt.toString());
               }
            }

         }
      });
      tpSaveButton.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/diskette.png")));
      ...
      tpSearchButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        String id = StaffFitFlow.this.tpSearchField.getText();
    	        String date = StaffFitFlow.this.tpDateLabel.getText();
    	        ...
    	        try (Connection con = ConnectionProvider.getCon()) {  // Using try-with-Resources to handle connection
    	            ...
    	            try (ResultSet rst = pst.executeQuery()) {
    	                if (rst.next()) {
    	                    checkID = true;
    	                    StaffFitFlow.this.tpEmailField.setText(rst.getString("email"));
    	                    StaffFitFlow.this.tpNameField.setText(rst.getString("name"));
    	                    StaffFitFlow.this.tpMnField.setText(rst.getString("mobile_number"));
      ...
      tpSearchButton.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/magnifying-glass.png")));
      ...
      tpResetButton1.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            StaffFitFlow.this.tpSearchField.setText("");
            StaffFitFlow.this.tpNameField.setText("");
            StaffFitFlow.this.tpMnField.setText("");
            StaffFitFlow.this.tpEmailField.setText("");
            StaffFitFlow.this.tpPaymentField.setText("");
      ...
      tpResetButton1.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/undo.png")));
      ...
      toPOSButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            StaffFitFlow.this.setVisible(false);
         }
      });
      toPOSButton.setBackground(new Color(224, 177, 25));
      toPOSButton.setIcon(new ImageIcon(StaffFitFlow.class.getResource("/Resources/POS.png")));
   ...
   private void checkForUnpaidTrainees() {
	...
	private void updatePaymentStatus(int traineeId, String name, int rowIndex) {
	    ...
	    try (Connection con = ConnectionProvider.getCon(); PreparedStatement pstmt = con.prepareStatement(updateQuery)) {
	...
	private void deleteTrainee(int traineeId, int rowIndex) {
	    ...
	    try (Connection con = ConnectionProvider.getCon(); PreparedStatement pstmt = con.prepareStatement(deleteQuery)) {
   ...
   private void populateMemberTable(DefaultTableModel model) {
	    try (Connection con = ConnectionProvider.getCon()) {  // Using try-with-Resources for connection
	        String query = "SELECT * FROM member";
