...
public class InboundUpdateOwnerOffline extends JFrame {
   private JComboBox<String> DStatusBox;
   private JDateChooser dateChooser;
   private String productId;
   private OwnerPOSOffline parentFrame;

   @SuppressWarnings({ "unchecked", "rawtypes" })
public InboundUpdateOwnerOffline(String productId, String eta, String status, OwnerPOSOffline ownerPOSOffline) {
   	setType(Type.UTILITY);
      this.productId = productId;
      this.parentFrame = ownerPOSOffline;
      this.getContentPane().setBackground(Color.BLACK);
      this.getContentPane().setLayout((LayoutManager)null);
      this.setSize(545, 223);
      this.setLocationRelativeTo((Component)null);
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(InboundUpdateOwnerOffline.class.getResource("/resources/Black_and_Brown_Vintage_Fitness_Center_Logo_-removebg-preview.png")));
      ...
      updateInbound.setIcon(new ImageIcon(InboundUpdateOwnerOffline.class.getResource("/resources/edit.png")));
