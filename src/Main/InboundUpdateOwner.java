...
public class InboundUpdateOwner extends JFrame {
...
public InboundUpdateOwner(String productId, String eta, String status, OwnerPOS ownerPOS) {
      ...
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(InboundUpdateOwner.class.getResource("/resources/Black_and_Brown_Vintage_Fitness_Center_Logo_-removebg-preview.png")));
      ...
      updateInbound.setIcon(new ImageIcon(InboundUpdateOwner.class.getResource("/resources/edit.png")));
