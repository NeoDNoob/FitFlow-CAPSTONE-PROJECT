...
public class AdminFitFlowOffline extends JFrame {
...
private String userType;
   ...
   private JTextField ntNameField;
   private JTextField ntAgeField;
   private JTextField ntMobileNumberField;
   private JTextField ntEmailField;
@SuppressWarnings("rawtypes")
private JComboBox ntPaymentTypeField;
private JButton ntAddButton;
private JButton ntResetButton;
@SuppressWarnings("rawtypes")
private JComboBox ntAddressField;

   @SuppressWarnings({ "unchecked", "rawtypes" })
public AdminFitFlowOffline(int selectedIndex, final String username, final String userType, final int loggedInUserId) {
    	                ...
    	                try (PreparedStatement ps = connection.prepareStatement(query)) {
    	                    ...
    	                    if (rowsUpdated > 0) {
    	                        if (choice == 0) {
    	                            ...
    	                            new LoginForm();
    	                            AdminFitFlowOffline.this.dispose();
    	                        }
    	                    } else {
      ...
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(AdminFitFlowOffline.class.getResource("/Resources/FitFlowIconPngResized.png")));
      ...
      this.tabbedPane.addChangeListener(new ChangeListener() {
		...
		public void stateChanged(ChangeEvent e) {
            ...
            if (selectedIndex == 1) {
               AdminFitFlowOffline.this.updateTableData();
               AdminFitFlowOffline.this.model.fireTableStructureChanged();
               AdminFitFlowOffline.this.checkForUnpaidTrainees();
            } else if (selectedIndex == 2) {
               AdminFitFlowOffline.this.updateActiveMembersLabel();
            } else if (selectedIndex == 3) {
               AdminFitFlowOffline.this.setDateLabel();
            } else if (selectedIndex == 4) {
               AdminFitFlowOffline.this.loadDataTable();
            }
      ...
      this.tabbedPane.addTab("Home ", new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/home-icon-silhouette.png")), homePanel, "Home");
      ...
      this.tabbedPane.addTab("Trainee List ", new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/group.png")), this.traineePanel, (String)null);
      JLabel traineeLabel = new JLabel("Trainee List");
      traineeLabel.setForeground(new Color(255, 215, 0));
      traineeLabel.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/users.png")));
      ...
      String[] sex = new String[]{"Select", "Active", "Inactive"};

      JPanel newTrainee = new JPanel();
      newTrainee.setBackground(new Color(0, 0, 0));
      tabbedPane.addTab("New Trainee", new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/add-group.png")), newTrainee, null);
      newTrainee.setLayout(null);

      JLabel lblNewTrainee = new JLabel("New Trainee");
      lblNewTrainee.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/add-group-BIG.png")));
      lblNewTrainee.setForeground(new Color(255, 215, 0));
      lblNewTrainee.setFont(new Font("Impact", Font.BOLD | Font.ITALIC, 47));
      lblNewTrainee.setBounds(571, 11, 339, 83);
      newTrainee.add(lblNewTrainee);

      JLabel ntNameLabel = new JLabel("Name");
      ntNameLabel.setForeground(new Color(255, 215, 0));
      ntNameLabel.setFont(new Font("Segoe UI", Font.BOLD, 19));
      ntNameLabel.setBounds(42, 141, 84, 24);
      newTrainee.add(ntNameLabel);

      ntNameField = new JTextField();
      ntNameField.setForeground(Color.WHITE);
      ntNameField.setFont(new Font("Segoe UI", Font.BOLD, 18));
      ntNameField.setColumns(10);
      ntNameField.setBackground(Color.DARK_GRAY);
      ntNameField.setBounds(42, 176, 357, 35);
      newTrainee.add(ntNameField);

      ntAgeField = new JTextField();
      ntAgeField.setForeground(Color.WHITE);
      ntAgeField.setFont(new Font("Segoe UI", Font.BOLD, 18));
      ntAgeField.setColumns(10);
      ntAgeField.setBounds(new Rectangle(0, 0, 213, 30));
      ntAgeField.setBackground(Color.DARK_GRAY);
      ntAgeField.setBounds(42, 280, 357, 35);
      newTrainee.add(ntAgeField);

      JLabel ntAgeLabel = new JLabel("Age");
      ntAgeLabel.setForeground(new Color(255, 215, 0));
      ntAgeLabel.setFont(new Font("Segoe UI", Font.BOLD, 19));
      ntAgeLabel.setBounds(42, 243, 84, 24);
      newTrainee.add(ntAgeLabel);

      JLabel ntSexLabel = new JLabel("Sex");
      ntSexLabel.setForeground(new Color(255, 215, 0));
      ntSexLabel.setFont(new Font("Segoe UI", Font.BOLD, 19));
      ntSexLabel.setBounds(468, 369, 84, 24);
      newTrainee.add(ntSexLabel);
      final JComboBox<String> ntSexField = new JComboBox(sex);
      ntSexField.setModel(new DefaultComboBoxModel(new String[] {"Select", "Male", "Female"}));
      ntSexField.setForeground(Color.WHITE);
      ntSexField.setFont(new Font("Segoe UI", Font.BOLD, 18));
      ntSexField.setBorder(new LineBorder(new Color(51, 51, 51), 2, true));
      ntSexField.setBackground(Color.DARK_GRAY);
      ntSexField.setBounds(468, 404, 115, 30);
      newTrainee.add(ntSexField);

      JLabel ntMobileNumberLabel = new JLabel("Mobile Number");
      ntMobileNumberLabel.setForeground(new Color(255, 215, 0));
      ntMobileNumberLabel.setFont(new Font("Segoe UI", Font.BOLD, 19));
      ntMobileNumberLabel.setBounds(468, 141, 187, 24);
      newTrainee.add(ntMobileNumberLabel);

      ntMobileNumberField = new JTextField();
      ntMobileNumberField.setForeground(Color.WHITE);
      ntMobileNumberField.setFont(new Font("Segoe UI", Font.BOLD, 18));
      ntMobileNumberField.setColumns(10);
      ntMobileNumberField.setBackground(Color.DARK_GRAY);
      ntMobileNumberField.setBounds(468, 176, 357, 35);
      newTrainee.add(ntMobileNumberField);

      JLabel ntEmailLabel = new JLabel("Email");
      ntEmailLabel.setForeground(new Color(255, 215, 0));
      ntEmailLabel.setFont(new Font("Segoe UI", Font.BOLD, 19));
      ntEmailLabel.setBounds(468, 243, 84, 24);
      newTrainee.add(ntEmailLabel);

      ntEmailField = new JTextField();
      ntEmailField.setForeground(Color.WHITE);
      ntEmailField.setFont(new Font("Segoe UI", Font.BOLD, 18));
      ntEmailField.setColumns(10);
      ntEmailField.setBounds(new Rectangle(0, 0, 213, 30));
      ntEmailField.setBackground(Color.DARK_GRAY);
      ntEmailField.setBounds(468, 280, 357, 35);
      newTrainee.add(ntEmailField);

      ntAddressField = new JComboBox(new Object[]{});
      ntAddressField.setModel(new DefaultComboBoxModel(new String[] {"Please Select", "San Pablo City, Laguna", "Alaminos, Laguna", "Nagcarlan, Laguna", "Dolores, Quezon", "Other"}));
      ntAddressField.setForeground(Color.WHITE);
      ntAddressField.setFont(new Font("Segoe UI", Font.BOLD, 18));
      ntAddressField.setBorder(new LineBorder(new Color(51, 51, 51), 2, true));
      ntAddressField.setBackground(Color.DARK_GRAY);
      ntAddressField.setBounds(42, 404, 313, 30);
      newTrainee.add(ntAddressField);
      JLabel lblPaymentType = new JLabel("Payment Type");
      lblPaymentType.setForeground(new Color(255, 215, 0));
      lblPaymentType.setFont(new Font("Segoe UI", Font.BOLD, 19));
      lblPaymentType.setBounds(666, 369, 187, 24);
      newTrainee.add(lblPaymentType);

      String[] paymentTF = new String[]{"Please select", "By Session", "Monthly"};
      ntPaymentTypeField = new JComboBox(paymentTF);
      ntPaymentTypeField.setForeground(Color.WHITE);
      ntPaymentTypeField.setBackground(Color.DARK_GRAY);
      ntPaymentTypeField.setModel(new DefaultComboBoxModel(new String[]{"Please select", "By Session", "Monthly"}));
      ntPaymentTypeField.setFont(new Font("Segoe UI", 1, 18));
      ntPaymentTypeField.setBounds(665, 404, 160, 30);
      ntPaymentTypeField.setBorder(new LineBorder(new Color(51, 51, 51), 2, true));
      newTrainee.add(ntPaymentTypeField);

      ntAddButton = new JButton("Add");
      ntAddButton.addActionListener(new ActionListener() {


		@Override
		public void actionPerformed(ActionEvent e) {
              String name = ntNameField.getText();
              int age = Integer.parseInt(ntAgeField.getText());
              String sex = (String) ntSexField.getSelectedItem();
              String mobileNumber = ntMobileNumberField.getText();
              String email = ntEmailField.getText();
              String address = (String) ntAddressField.getSelectedItem();
              String paymentType = (String) ntPaymentTypeField.getSelectedItem();

              try {
                  Connection con = ConnectionProviderOFFLINE.getCon();
                  String query = "INSERT INTO member (email, name, age, sex, address, mobile_number, payment_time) VALUES (?, ?, ?, ?, ?, ?, ?)";
      ...
      ntAddButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/changes.png")));
      ntAddButton.setForeground(Color.BLACK);
      ntAddButton.setFont(new Font("Segoe UI", Font.BOLD, 18));
      ntAddButton.setFocusable(false);
      ntAddButton.setBorder(new LineBorder(new Color(51, 51, 51), 2, true));
      ntAddButton.setBackground(new Color(255, 204, 51));
      ntAddButton.setBounds(468, 497, 115, 30);
      newTrainee.add(ntAddButton);

      ntResetButton = new JButton("Reset");
      ntResetButton.addActionListener(new ActionListener() {
      	@Override
		public void actionPerformed(ActionEvent e) {
      		ntNameField.setText("");
      		ntAgeField.setText("");

      		ntEmailField.setText("");
      		ntMobileNumberField.setText("");
      		ntSexField.setSelectedItem("Select");
      		ntPaymentTypeField.setSelectedItem("Please Select");
      	}
      });
      ntResetButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/undo.png")));
      ntResetButton.setForeground(Color.BLACK);
      ntResetButton.setFont(new Font("Segoe UI", Font.BOLD, 18));
      ntResetButton.setFocusable(false);
      ntResetButton.setBorder(new LineBorder(new Color(51, 51, 51), 2, true));
      ntResetButton.setBackground(new Color(255, 204, 51));
      ntResetButton.setBounds(666, 497, 120, 30);
      newTrainee.add(ntResetButton);

      JLabel ntAddressFIeld = new JLabel("Address");
      ntAddressFIeld.setForeground(new Color(255, 215, 0));
      ntAddressFIeld.setFont(new Font("Segoe UI", Font.BOLD, 19));
      ntAddressFIeld.setBounds(42, 359, 84, 24);
      newTrainee.add(ntAddressFIeld);
      ...
      this.tabbedPane.addTab("Manage Trainee ", new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/user-avatar.png")), this.editTraineePanel, (String)null);
      ...
      lblEditTrainee.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/pencil.png")));
      ...
      String[] mtpaymentTF = new String[]{"Please select", "By Session", "Monthly"};
      mtPaymentTimeField = new JComboBox(mtpaymentTF);
      ...
      mtSearchButton.addActionListener(new ActionListener() {
    	    ...
    	    public void actionPerformed(ActionEvent e) {
    	        ...
    	        String id = AdminFitFlowOffline.this.mtSearchField.getText().trim();
    	        ...
    	        try (Connection con = ConnectionProviderOFFLINE.getCon();
    	            ...
    	            try (ResultSet rst = ps.executeQuery()) {
    	                ...
    	                while (rst.next()) {
    	                    checkID = true;
    	                    AdminFitFlowOffline.this.mtNameField.setText(rst.getString("name"));
    	                    AdminFitFlowOffline.this.mtAgeField.setText(rst.getString("age"));
    	                    AdminFitFlowOffline.this.mtSexField.setText(rst.getString("sex"));
    	                    AdminFitFlowOffline.this.mtSexField.setEditable(false);
    	                    AdminFitFlowOffline.this.mtMnField.setText(rst.getString("mobile_number"));
    	                    AdminFitFlowOffline.this.mtEmailField.setText(rst.getString("email"));
      ...
      mtSearchButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/magnifying-glass.png")));
      mtSearchButton.setFont(new Font("Segoe UI", 1, 18));
      this.editTraineePanel.add(mtSearchButton);
      JLabel mtNameLabel = new JLabel("Name");
      mtNameLabel.setForeground(new Color(255, 215, 0));
      mtNameLabel.setBounds(64, 134, 84, 24);
      mtNameLabel.setFont(new Font("Segoe UI", 1, 19));
      this.editTraineePanel.add(mtNameLabel);
      ...
      JLabel mtAgeLabel = new JLabel("Age");
      mtAgeLabel.setForeground(new Color(255, 215, 0));
      mtAgeLabel.setBounds(64, 210, 50, 30);
      mtAgeLabel.setFont(new Font("Segoe UI", 1, 19));
      this.editTraineePanel.add(mtAgeLabel);
      ...
      JLabel mtSexLabel = new JLabel("Sex");
      mtSexLabel.setForeground(new Color(255, 215, 0));
      mtSexLabel.setBounds(64, 297, 46, 24);
      mtSexLabel.setFont(new Font("Segoe UI", 1, 19));
      this.editTraineePanel.add(mtSexLabel);
      ...
      JLabel mtMobileNumber = new JLabel("Mobile Number");
      mtMobileNumber.setForeground(new Color(255, 215, 0));
      mtMobileNumber.setFont(new Font("Segoe UI", 1, 19));
      mtMobileNumber.setBounds(476, 139, 150, 24);
      this.editTraineePanel.add(mtMobileNumber);
      ...
      mtUpdateButton.addActionListener(new ActionListener() {
    	    ...
    	    public void actionPerformed(ActionEvent e) {
    	        ...
    	        String id = AdminFitFlowOffline.this.mtSearchField.getText().trim();
    	        String name = AdminFitFlowOffline.this.mtNameField.getText().trim();
    	        String age = AdminFitFlowOffline.this.mtAgeField.getText().trim();
    	        String mobileNumber = AdminFitFlowOffline.this.mtMnField.getText().trim();
    	        String email = AdminFitFlowOffline.this.mtEmailField.getText().trim();
    	        ...
    	        try (Connection con = ConnectionProviderOFFLINE.getCon();
    	            ...
    	            if (rowsUpdated > 0) {
    	                ...
    	                AdminFitFlowOffline.this.mtSearchField.setText("");
    	                AdminFitFlowOffline.this.mtSearchField.setEditable(true);
    	                AdminFitFlowOffline.this.mtNameField.setText("");
    	                AdminFitFlowOffline.this.mtAgeField.setText("");
    	                AdminFitFlowOffline.this.mtSexField.setText("");
    	                AdminFitFlowOffline.this.mtEmailField.setText("");
    	                AdminFitFlowOffline.this.mtMnField.setText("");
      ...
      mtUpdateButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/changes.png")));
      ...
      mtDeleteButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/trash.png")));
      ...
      mtResetButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/undo.png")));
      ...
      this.tabbedPane.addTab("Trainee Payment ", new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/wallet-filled-money-tool.png")), membershipPaymentPanel, "Trainee Payment");
      ...
      lblPayment.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/wallet.png")));
      ...
      tpSaveButton.addActionListener(new ActionListener() {
    	    @Override
    	    public void actionPerformed(ActionEvent e) {
    	        String memberName = AdminFitFlowOffline.this.tpNameField.getText();
    	        String paymentTime = (String) tpPaymentTimeField.getSelectedItem();

    	        if (AdminFitFlowOffline.this.isPaymentAllowed(memberName, paymentTime)) {
    	            String date = AdminFitFlowOffline.this.tpDateLabel.getText();
    	            String amount = AdminFitFlowOffline.this.tpPaymentField.getText();
    	            ...
    	            try (Connection con = ConnectionProviderOFFLINE.getCon();
    	                ...
    	                AdminFitFlowOffline.this.tableDetails();
    	            ...
    	            if (result == 0) {
    	                AdminFitFlowOffline.this.printReceipt(receipt.toString());
    	            }

    	            // Clear input fields
    	            AdminFitFlowOffline.this.tpNameField.setText("");
    	            AdminFitFlowOffline.this.tpPaymentField.setText("");
    	            AdminFitFlowOffline.this.tpEmailField.setText("");
    	            AdminFitFlowOffline.this.tpMnField.setText("");
    	            tpPaymentTimeField.setSelectedItem("Please Select");
    	        }
    	    }
    	});

      tpSaveButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/diskette.png")));
      ...
      tpSearchButton.addActionListener(new ActionListener() {
    	    ...
    	    public void actionPerformed(ActionEvent e) {
    	        AdminFitFlowOffline.this.setDateLabel();
    	        String id = AdminFitFlowOffline.this.tpSearchField.getText();
    	        String date = AdminFitFlowOffline.this.tpDateLabel.getText();
    	        ...
    	        try (Connection con = ConnectionProviderOFFLINE.getCon()) {
    	            ...
    	            try (PreparedStatement pst = con.prepareStatement(memberQuery)) {
    	                ...
    	                try (ResultSet rst = pst.executeQuery()) {
    	                    if (rst.next()) {
    	                        checkID = true;
    	                        AdminFitFlowOffline.this.tpEmailField.setText(rst.getString("email"));
    	                        AdminFitFlowOffline.this.tpNameField.setText(rst.getString("name"));
    	                        AdminFitFlowOffline.this.tpMnField.setText(rst.getString("mobile_number"));
      ...
      tpSearchButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/magnifying-glass.png")));
      ...
      tpResetButton1.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminFitFlowOffline.this.tpSearchField.setText("");
            AdminFitFlowOffline.this.tpNameField.setText("");
            AdminFitFlowOffline.this.tpMnField.setText("");
            AdminFitFlowOffline.this.tpEmailField.setText("");
            AdminFitFlowOffline.this.tpPaymentField.setText("");
      ...
      tpResetButton1.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/undo.png")));
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        if (confirm != null && !confirm.isEmpty()) {
    	            if (confirm.equals("Confirm")) {
    	                int selectedRow = AdminFitFlowOffline.this.tpTable.getSelectedRow();
    	                if (selectedRow != -1) {
    	                    ...
    	                    if (confirmation == JOptionPane.YES_OPTION) {
    	                        String date = (String) AdminFitFlowOffline.this.tpTable.getValueAt(selectedRow, 1);
    	                        String name = (String) AdminFitFlowOffline.this.tpTable.getValueAt(selectedRow, 0);

    	                        String query = "DELETE FROM payments WHERE date = ? AND member_name = ?";

    	                        try (Connection con1 = ConnectionProviderOFFLINE.getCon();
    	                            ...
    	                            if (rowsDeleted > 0) {
    	                                DefaultTableModel dtm = (DefaultTableModel) AdminFitFlowOffline.this.tpTable.getModel();
      ...
      tpDeleteButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/trash.png")));
      ...
      this.tpDateSorter.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            String selectedOption = (String)AdminFitFlowOffline.this.tpDateSorter.getSelectedItem();
            switch(selectedOption.hashCode()) {
            case -1650694486:
               if (selectedOption.equals("Yearly")) {
                  AdminFitFlowOffline.this.tpMonthSorter.setVisible(false);
                  AdminFitFlowOffline.this.tpYearSorter.setVisible(true);
                  AdminFitFlowOffline.this.showYearlyPayments();
               }
               break;
            case -1393678355:
               if (selectedOption.equals("Monthly")) {
                  AdminFitFlowOffline.this.tpMonthSorter.setVisible(true);
                  AdminFitFlowOffline.this.tpYearSorter.setVisible(true);
                  AdminFitFlowOffline.this.showMonthlyPayments();
               }
               break;
            case 65921:
               if (selectedOption.equals("All")) {
                  AdminFitFlowOffline.this.tableDetails();
                  AdminFitFlowOffline.this.tpMonthSorter.setVisible(false);
                  AdminFitFlowOffline.this.tpYearSorter.setVisible(false);
               }
               break;
            case 80981793:
               if (selectedOption.equals("Today")) {
                  AdminFitFlowOffline.this.showTodayPayments();
                  AdminFitFlowOffline.this.tpMonthSorter.setVisible(false);
                  AdminFitFlowOffline.this.tpYearSorter.setVisible(false);
               }
               break;
            case 1384532022:
               if (selectedOption.equals("This Week")) {
                  AdminFitFlowOffline.this.showThisWeekPayments();
                  AdminFitFlowOffline.this.tpMonthSorter.setVisible(false);
                  AdminFitFlowOffline.this.tpYearSorter.setVisible(false);
               }
            }
      ...
      this.tabbedPane.addTab("Gym Reports", new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/sales.png")), this.gymReports, (String)null);
      ...
      this.yearComboBox.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminFitFlowOffline.this.updateMembershipChart();
         }
      });
      this.membershipButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminFitFlowOffline.this.cardLayout.show(AdminFitFlowOffline.this.cardPanel, "Membership");
            AdminFitFlowOffline.this.updateMembershipChart();
            yearLabel.setVisible(true);
            AdminFitFlowOffline.this.yearComboBox.setVisible(true);
         }
      });
      this.paymentTypeButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminFitFlowOffline.this.cardLayout.show(AdminFitFlowOffline.this.cardPanel, "PaymentType");
            AdminFitFlowOffline.this.updatePaymentTypeChart();
         }
      });
      this.ageDistributionButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminFitFlowOffline.this.cardLayout.show(AdminFitFlowOffline.this.cardPanel, "AgeDistribution");
            AdminFitFlowOffline.this.updateAgeDistributionChart();
         }
      });
      this.addressDistributionButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminFitFlowOffline.this.cardLayout.show(AdminFitFlowOffline.this.cardPanel, "AddressDistribution");
            AdminFitFlowOffline.this.updateAddressDistributionChart();
         }
      });
      this.genderDistributionButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminFitFlowOffline.this.cardLayout.show(AdminFitFlowOffline.this.cardPanel, "GenderDistribution");
            AdminFitFlowOffline.this.updateGenderDistributionChart();
         }
      });
      ...
      this.tabbedPane.addTab("User List ", new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/shortlist.png")), UserLists, "User List");
      UserLists.setLayout((LayoutManager)null);
      JLabel lblUserList = new JLabel("User List");
      lblUserList.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/userlist.png")));
      ...
      this.ulTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
    	        ...
    	        try (Connection con = ConnectionProviderOFFLINE.getCon();
    	            ...
    	            try (ResultSet rs = ps.executeQuery()) {
    	                if (rs.next()) {
    	                    ...
    	                    AdminFitFlowOffline.this.ulNameField.setText(name);
    	                    AdminFitFlowOffline.this.ulUserField.setText(username);
    	                    AdminFitFlowOffline.this.ulPasswordField.setText(password);
    	                }
			...
			public void valueChanged(ListSelectionEvent e) {
    	        if (!e.getValueIsAdjusting()) {
    	            int selectedRow = AdminFitFlowOffline.this.ulTable.getSelectedRow();
    	            if (selectedRow != -1) {
    	                String selectedIdString = (String) AdminFitFlowOffline.this.ulTable.getValueAt(selectedRow, 0);
      ...
      addUser.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/add-user.png")));
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        if (confirm != null && !confirm.isEmpty()) {
    	            if (confirm.equals("Confirm")) {
    	                int selectedRow = AdminFitFlowOffline.this.ulTable.getSelectedRow();
    	                if (selectedRow != -1) {
    	                    String userType = (String) AdminFitFlowOffline.this.ulTable.getValueAt(selectedRow, 2);
    	                    String username = (String) AdminFitFlowOffline.this.ulTable.getValueAt(selectedRow, 1);
    	                    ...
    	                    try (Connection con = ConnectionProviderOFFLINE.getCon();
    	                        ...
    	                        if (rowsDeleted > 0) {
    	                            DefaultTableModel model1 = (DefaultTableModel) AdminFitFlowOffline.this.ulTable.getModel();
      ...
      deleteUser.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/delete-user.png")));
      ...
      showPassword.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/hidden.png")));
      showPassword.setSelectedIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/eye.png")));
      ...
      ulEditButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminFitFlowOffline.this.ulNameField.setEnabled(true);
            AdminFitFlowOffline.this.ulUserField.setEnabled(true);
            AdminFitFlowOffline.this.ulPasswordField.setEnabled(true);
         }
      });
      ulEditButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/edit.png")));
      ...
      ulUpdateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
    	        String id = AdminFitFlowOffline.this.ulUserIdTextField.getText();
    	        String name = AdminFitFlowOffline.this.ulNameField.getText();
    	        String username = AdminFitFlowOffline.this.ulUserField.getText();
    	        String password = AdminFitFlowOffline.this.ulPasswordField.getText();
    	        ...
    	        try (Connection con = ConnectionProviderOFFLINE.getCon();
    	            ...
    	            if (rowsUpdated > 0) {
    	                ...
    	                AdminFitFlowOffline.this.loadDataTable();
    	                AdminFitFlowOffline.this.ulUserIdTextField.setText("");
    	                AdminFitFlowOffline.this.ulNameField.setText("");
    	                AdminFitFlowOffline.this.ulUserField.setText("");
    	                AdminFitFlowOffline.this.ulPasswordField.setText("");
    	            } else {
      ...
      ulUpdateButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/changes.png")));
      ...
      ulResetButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            AdminFitFlowOffline.this.ulUserField.setText("");
            AdminFitFlowOffline.this.ulPasswordField.setText("");
            AdminFitFlowOffline.this.ulNameField.setEnabled(false);
            AdminFitFlowOffline.this.ulUserField.setEnabled(false);
            AdminFitFlowOffline.this.ulPasswordField.setEnabled(false);
         }
      });
      ulResetButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/undo.png")));
    	        ...
    	        try (Connection con = ConnectionProviderOFFLINE.getCon();
    	            ...
    	            try (PreparedStatement pstmt = con.prepareStatement(query)) {
    	                ...
    	                try (ResultSet rst = pstmt.executeQuery()) {
    	                    if (rst.next()) {
    	                        userFound = true;
    	                        AdminFitFlowOffline.this.ulUserField.setText(rst.getString("username"));
    	                        AdminFitFlowOffline.this.ulNameField.setText(rst.getString("name"));
    	                        AdminFitFlowOffline.this.ulPasswordField.setText(rst.getString("password"));
    	                    }
      ...
      ulSearchButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/magnifying-glass.png")));
      ...
      showPassword.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            if (showPassword.isSelected()) {
               AdminFitFlowOffline.this.ulPasswordField.setEchoChar('\u0000');
            } else {
               AdminFitFlowOffline.this.ulPasswordField.setEchoChar('●');
            }
      ...
      toPOSButton.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            AdminPOSOffline adminPOS = new AdminPOSOffline(0, username, userType, loggedInUserId);
            adminPOS.setVisible(true);
            AdminFitFlowOffline.this.setVisible(false);
         }
      });
      toPOSButton.setBackground(new Color(224, 177, 25));
      toPOSButton.setIcon(new ImageIcon(AdminFitFlowOffline.class.getResource("/Resources/POS.png")));
   ...
   private void checkForUnpaidTrainees() {
	    for (int i = 0; i < this.model.getRowCount(); ++i) {
	        ...
	        if ("Unpaid".equalsIgnoreCase(membershipFee)) {
	            ...
	            int response = JOptionPane.showConfirmDialog((Component) null, "Did " + name + " already pay the membership fee?", "Unpaid Membership Fee", 0, 3);
	            if (response == 0) {
   ...
   public void showMonthlyPayments() {
	    this.tpMonthSorter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
	            DefaultTableModel dtm = (DefaultTableModel) AdminFitFlowOffline.this.tpTable.getModel();
	            dtm.setRowCount(0);
	            int monthIndex = AdminFitFlowOffline.this.tpMonthSorter.getSelectedIndex() + 1;
	            String selectedYear = (String) AdminFitFlowOffline.this.tpYearSorter.getSelectedItem();
