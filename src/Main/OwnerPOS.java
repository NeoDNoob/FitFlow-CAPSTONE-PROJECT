...
public class OwnerPOS extends JFrame implements Runnable {
...
private String userType;
   ...
   public OwnerPOS(int selectedIndex, final String username, final String userType, final int loggedInUserId) {
      ...
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(OwnerPOS.class.getResource("/Resources/FitFlowIconPngResized.png")));
      ...
      this.POSInvTabbedPane.addChangeListener(new ChangeListener() {
		...
		public void stateChanged(ChangeEvent e) {
            ...
            if (selectedIndex == 1) {
               OwnerPOS.this.clearPosProductFields();
               OwnerPOS.this.checkOverstock();
               OwnerPOS.this.loadTableData();
               OwnerPOS.this.populateInboundTable();
            } else if (selectedIndex == 2) {
               OwnerPOS.this.populateInboundTable();
               OwnerPOS.this.clearInvProductFields();
      ...
      new ImageIcon(OwnerPOS.class.getResource("/Resources/POSicon.png"));
      ...
      this.POSInvTabbedPane.addTab("Point of Sale", new ImageIcon(OwnerPOS.class.getResource("/Resources/POS.png")), pos, "Point of Sale");
      ...
      this.posBarcodeField.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
    	        if (e.getKeyCode() == 10) {
    	            String barcode = OwnerPOS.this.posBarcodeField.getText();
    	            ...
    	            try (Connection con = ConnectionProvider.getCon();
    	                ...
    	                try (ResultSet rs = pstmt.executeQuery()) {
    	                    if (rs.next()) {
    	                        OwnerPOS.this.posProductNameField.setText(rs.getString("product_name"));
    	                        OwnerPOS.this.posPriceField.setText(rs.getString("retail_price"));
    	                        OwnerPOS.this.posQtyField.setText("1");
    	                    } else {
    	                        JOptionPane.showMessageDialog((Component) null, "Barcode not found.");
    	                        OwnerPOS.this.posBarcodeField.setText("");
    	                    }
    	                }
      ...
      posMinusButt.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            int currentQty = Integer.parseInt(OwnerPOS.this.posQtyField.getText());
            if (currentQty > 0) {
               --currentQty;
               OwnerPOS.this.posQtyField.setText(String.valueOf(currentQty));
               if (currentQty == 0) {
      ...
      posMinusButt.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/minus.png")));
      ...
      posAddButt.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/addition.png")));
      ...
      toCartField.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/add-to-cart.png")));
      ...
      POSLabel.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/payment-terminal(1).png")));
      ...
      posDeleteButton.addMouseListener(new MouseAdapter() {
         @Override
		public void mouseClicked(MouseEvent e) {
            OwnerPOS.this.cartTableModel.removeRow(OwnerPOS.this.cartTable.getSelectedRow());
            int sum = 0;

            for(int i = 0; i < OwnerPOS.this.cartTable.getRowCount(); ++i) {
               sum += Integer.parseInt(OwnerPOS.this.cartTable.getValueAt(i, 4).toString());
            }

            OwnerPOS.this.posSTField.setText(Integer.toString(sum));
         }
      });
      posDeleteButton.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/trash.png")));
      ...
      posFInalize.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            int pay = Integer.parseInt(OwnerPOS.this.posPayField.getText());
            int subtotal = Integer.parseInt(OwnerPOS.this.posSTField.getText());
            int balance = pay - subtotal;
            OwnerPOS.this.posChangeField.setText(String.valueOf(balance));
            OwnerPOS.this.sales(username);
            OwnerPOS.this.salesModel.fireTableStructureChanged();
            OwnerPOS.this.tableModel.fireTableStructureChanged();
         }
      });
      posFInalize.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/bill.png")));
      ...
      this.POSInvTabbedPane.addTab("Inventory", new ImageIcon(OwnerPOS.class.getResource("/Resources/list.png")), inventory, (String)null);
      inventory.setLayout((LayoutManager)null);
      JLabel inventoryLabel = new JLabel("Inventory");
      inventoryLabel.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/shipping.png")));
      ...
      invAddProd.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
        	 AddProductOwner add = new AddProductOwner(OwnerPOS.this);
            add.setVisible(true);
         }
      });
      invAddProd.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/add-small.png")));
      ...
      this.invTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
		...
		public void valueChanged(ListSelectionEvent e) {
            if (!e.getValueIsAdjusting()) {
               int selectedRow = OwnerPOS.this.invTable.getSelectedRow();
               if (selectedRow != -1) {
                  OwnerPOS.this.invBarcodeField.setText((String)OwnerPOS.this.invTable.getValueAt(selectedRow, 1));
                  OwnerPOS.this.invProductNameField.setText((String)OwnerPOS.this.invTable.getValueAt(selectedRow, 2));
                  OwnerPOS.this.invQtyField.setText(String.valueOf(OwnerPOS.this.invTable.getValueAt(selectedRow, 3)));
                  OwnerPOS.this.invCpField.setText(String.valueOf(OwnerPOS.this.invTable.getValueAt(selectedRow, 4)));
                  OwnerPOS.this.invRpField.setText(String.valueOf(OwnerPOS.this.invTable.getValueAt(selectedRow, 5)));
               }
            }
      ...
      invUpdateProduct.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            int selectedRow = OwnerPOS.this.inboundTable.getSelectedRow();
            if (selectedRow == -1) {
               JOptionPane.showMessageDialog(OwnerPOS.this, "Please select a row to update.");
            } else {
               String productId = OwnerPOS.this.inboundTable.getValueAt(selectedRow, 0).toString();
               String eta = OwnerPOS.this.inboundTable.getValueAt(selectedRow, 6).toString();
               String status = OwnerPOS.this.inboundTable.getValueAt(selectedRow, 7).toString();
               InboundUpdateOwner updateInboundFrame = new InboundUpdateOwner(productId, eta, status, OwnerPOS.this);
               updateInboundFrame.setVisible(true);
            }
         }
      });
      invUpdateProduct.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/edit.png")));
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        if (confirm != null && !confirm.isEmpty()) {
    	            if (confirm.equals("Confirm")) {
    	                int selectedRow = OwnerPOS.this.invTable.getSelectedRow();
    	                if (selectedRow != -1) {
    	                    int id = (Integer) OwnerPOS.this.invTable.getValueAt(selectedRow, 0);
    	                    String barcode = (String) OwnerPOS.this.invTable.getValueAt(selectedRow, 1);
    	                    ...
    	                    try (Connection con = ConnectionProvider.getCon();
    	                        ...
    	                        if (rowsAffected > 0) {
    	                            DefaultTableModel cartTableModel = (DefaultTableModel) OwnerPOS.this.invTable.getModel();
      ...
      invDeleteProduct.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/trash.png")));
      ...
      delivered.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
    	        ...
    	        if (selectedRow == -1) {
    	            ...
    	            try (Connection con = ConnectionProvider.getCon()) {
    	                if (con != null) {
    	                    String productName = (String) OwnerPOS.this.inboundTable.getValueAt(selectedRow, 1);
    	                    String barcode = (String) OwnerPOS.this.inboundTable.getValueAt(selectedRow, 2);
    	                    int quantity = Integer.parseInt(OwnerPOS.this.inboundTable.getValueAt(selectedRow, 3).toString());
    	                    double costPrice = Double.parseDouble(OwnerPOS.this.inboundTable.getValueAt(selectedRow, 4).toString());
    	                    double retailPrice = Double.parseDouble(OwnerPOS.this.inboundTable.getValueAt(selectedRow, 5).toString());
    	                    Date etaDate = (Date) OwnerPOS.this.inboundTable.getValueAt(selectedRow, 6);
    	                    @SuppressWarnings("unused")
							String status = (String) OwnerPOS.this.inboundTable.getValueAt(selectedRow, 7);
    	                    Date today = new Date();
    	                    ...
    	                    ((DefaultTableModel) OwnerPOS.this.inboundTable.getModel()).removeRow(selectedRow);
    	                    OwnerPOS.this.loadTableData();
    	                }
      ...
      delivered.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/changes.png")));
      ...
      this.POSInvTabbedPane.addTab("History", new ImageIcon(OwnerPOS.class.getResource("/Resources/file.png")), this.history, (String)null);
      this.history.setLayout((LayoutManager)null);
      JLabel lblHistory = new JLabel("History");
      lblHistory.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/filegold.png")));
      ...
      dateSortYears.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if (!selectedYear.equals("Select Year")) {
               OwnerPOS.this.populateYearlySales(selectedYear);
            }
      ...
      dateSortMonths.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if (!selectedMonth.equals("Select Month") && !selectedYear.equals("Select Year")) {
               ...
               OwnerPOS.this.populateMonthlySales(monthNumber, selectedYear);
            }
	...
	final JComboBox<String> dateSort1 = new JComboBox(sortingOptionsDate);
		...
		public void actionPerformed(ActionEvent e) {
            ...
            case 80981793:
               if (selectedOption.equals("Today")) {
                  dateSortMonths.setVisible(false);
                  dateSortYears.setVisible(false);
                  OwnerPOS.this.populateDailySales();
                  return;
               }
               break;
            case 1384532022:
               if (selectedOption.equals("This Week")) {
                  dateSortMonths.setVisible(false);
                  dateSortYears.setVisible(false);
                  OwnerPOS.this.populateWeeklySales();
                  return;
               }
            }
      ...
      sortComboBox.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            OwnerPOS.this.sortByColumn = selectedOption.equals("Total Sales") ? "total_sales_amount" : "s.date";
            ...
            OwnerPOS.this.populateSalesHistory(OwnerPOS.this.salesModel, OwnerPOS.this.sortByColumn);
            OwnerPOS.this.salesModel.fireTableStructureChanged();
         }
      });
      JButton viewDetailsButton = new JButton("View Details");
      viewDetailsButton.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/search-file.png")));
      ...
      viewDetailsButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if (selectedRow != -1) {
               ...
               OwnerPOS.this.showOrderDetails(salesId);
            } else {
      ...
      this.POSInvTabbedPane.addTab("Sales Report", new ImageIcon(OwnerPOS.class.getResource("/Resources/sales.png")), report, (String)null);
      report.setLayout((LayoutManager)null);
      JLabel lblSalesReport = new JLabel("Sales Report");
      lblSalesReport.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/sales-gold.png")));
      ...
      exportButton.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/pdf-file.png")));
      ...
      toggleSalesSummary.addActionListener(new ActionListener() {
         @Override
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOS.this.contentPanel.getLayout();
            cl.show(OwnerPOS.this.contentPanel, "Sales Summary");
         }
      });
      toggleSalesOverTimeChart.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOS.this.contentPanel.getLayout();
            cl.show(OwnerPOS.this.contentPanel, "Sales Over Time Chart");
         }
      });
      toggleProductSales.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOS.this.contentPanel.getLayout();
            cl.show(OwnerPOS.this.contentPanel, "Product Sales");
         }
      });
      toggleProfitMargins.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOS.this.contentPanel.getLayout();
            cl.show(OwnerPOS.this.contentPanel, "Profit Margins");
         }
      });
      tglbtnOverallGym.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            CardLayout cl = (CardLayout)OwnerPOS.this.contentPanel.getLayout();
            cl.show(OwnerPOS.this.contentPanel, "Payments and Sales Summary");
         }
      });
      ...
      toGMButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            OwnerPOS.this.setVisible(false);
         }
      });
      toGMButton.setBackground(new Color(224, 177, 25));
      toGMButton.setIcon(new ImageIcon(OwnerPOS.class.getResource("/Resources/weight.png")));
