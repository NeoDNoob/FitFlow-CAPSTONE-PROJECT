...
public class AddUserOffline extends JFrame {
...
AddUserOffline() {
      this.setIconImage(Toolkit.getDefaultToolkit().getImage(AddUserOffline.class.getResource("/resources/FitFlowIconPngResized.png")));
      ...
      createButton.setIcon(new ImageIcon(AddUserOffline.class.getResource("/resources/diskette.png")));
      createButton.addActionListener(new ActionListener() {
    	    @Override
			public void actionPerformed(ActionEvent e) {
    	        String newUsername = AddUserOffline.this.usernameField.getText().trim();
    	        @SuppressWarnings("deprecation")
    	        String newPassword = AddUserOffline.this.passwordField.getText().trim();
    	        String userType = userTypeField.getSelectedItem().toString();
    	        String newName = AddUserOffline.this.nameField.getText().trim(); // Get name from nameField
      ...
      btnCancel.setIcon(new ImageIcon(AddUserOffline.class.getResource("/resources/cancel.png")));
      ...
      showPassword.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
            if (showPassword.isSelected()) {
               AddUserOffline.this.passwordField.setEchoChar('\u0000');
            } else {
               AddUserOffline.this.passwordField.setEchoChar('●');
            }
